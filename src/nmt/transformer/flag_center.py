...
flags.DEFINE_string(name='model_dir', default='./out/nmt', help='模型的位置')
flags.DEFINE_string(name='data_dir', default='./dat/nmt/iwslt2016', help='训练和测试数据的位置')
flags.DEFINE_string(name='bpe_model_file', default='./dat/nmt/m.model', help='bpe 模型位置')
...
flags.DEFINE_string(name='model_config', default='./cfg/nmt/transformer.json', help='模型配置位置')
